...
func NewOverrideFixerV1[T migrator.Entity](base *gorm.DB, target *gorm.DB, columns []string) *OverrideFixer[T] {
...
func NewOverriderFixer[T migrator.Entity](base *gorm.DB, target *gorm.DB) (*OverrideFixer[T], error) {
