...
import (
	...
	dao "github.com/WeiXinao/basic-go/webook/internal/repository/dao"
...
func (m *MockUserDao) FindByEmail(ctx context.Context, u dao.User) (dao.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserDaoMockRecorder) FindByEmail(ctx, u any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByEmail", reflect.TypeOf((*MockUserDao)(nil).FindByEmail), ctx, u)
}
...
func (m *MockUserDao) UpdateProfile(ctx context.Context, u dao.User) error {
	m.ctrl.T.Helper()
...
func (mr *MockUserDaoMockRecorder) UpdateProfile(ctx, u any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateProfile", reflect.TypeOf((*MockUserDao)(nil).UpdateProfile), ctx, u)
}
