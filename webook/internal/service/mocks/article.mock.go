...
func (m *MockArticleService) GetByAuthor(ctx *gin.Context, uid int64, offset, limit int) ([]domain.Article, error) {
	m.ctrl.T.Helper()
...
func (m *MockArticleService) GetPubById(ctx *gin.Context, id, uid int64) (domain.Article, error) {
	m.ctrl.T.Helper()
